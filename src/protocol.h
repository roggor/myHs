...
typedef struct
{
	uint32_t recvHiPrioPartial;
	uint32_t recvLoPrioPartial;
	uint32_t sendHiPrioFrames;
	uint32_t sendLoPrioFrames;
	uint32_t recvHiPrioOk;
	uint32_t recvLoPrioOk;
	uint32_t recvHiPrioTimeouts;
	uint32_t recvLoPrioTimeouts;
	uint32_t recvHiPrioErrCRC;
