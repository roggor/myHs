...
#include <string.h>
#include "protocol.h"
#include "rozmieniarka.h"


Rozmieniarka_t Rozmieniarka;

void Rozmieniarka_t::hwWriteSSP(bool hiPrio)
{
	protoFuncWriteSSP(rs485Addr, hopTxBuff.cc2RawBytes, hopTxDataLen, nvTxBuff.cc2RawBytes, nvTxDataLen, hiPrio);
}

void Rozmieniarka_t::setHopReqFloat(uint32_t amount, currency_t currency, bool wrHw, bool hiPrio)
{
